...
type UpdateTokensResponce struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	AccessToken   string                 `protobuf:"bytes,1,opt,name=access_token,json=accessToken,proto3" json:"access_token,omitempty"`
	RefreshToken  string                 `protobuf:"bytes,2,opt,name=refresh_token,json=refreshToken,proto3" json:"refresh_token,omitempty"`
	unknownFields protoimpl.UnknownFields
...
func (x *UpdateTokensResponce) Reset() {
	*x = UpdateTokensResponce{}
	mi := &file_proto_auth_auth_proto_msgTypes[5]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *UpdateTokensResponce) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*UpdateTokensResponce) ProtoMessage() {}

func (x *UpdateTokensResponce) ProtoReflect() protoreflect.Message {
	mi := &file_proto_auth_auth_proto_msgTypes[5]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use UpdateTokensResponce.ProtoReflect.Descriptor instead.
func (*UpdateTokensResponce) Descriptor() ([]byte, []int) {
	return file_proto_auth_auth_proto_rawDescGZIP(), []int{5}
}

func (x *UpdateTokensResponce) GetAccessToken() string {
	if x != nil {
		return x.AccessToken
	}
	return ""
...
func (x *UpdateTokensResponce) GetRefreshToken() string {
	if x != nil {
		return x.RefreshToken
	}
	return ""
...
const file_proto_auth_auth_proto_rawDesc = "" +
	"\n" +
	"\x15proto/auth/auth.proto\x12\x04auth\"\x96\x01\n" +
	...
	"\fUpdateTokens\x12\x19.auth.UpdateTokensRequest\x1a\x1a.auth.UpdateTokensResponceB\x0eZ\fpkg/api/authb\x06proto3"
...
var file_proto_auth_auth_proto_goTypes = []any{
	...
	(*UpdateTokensResponce)(nil), // 5: auth.UpdateTokensResponce
}
var file_proto_auth_auth_proto_depIdxs = []int32{
	...
	5, // 5: auth.Auth.UpdateTokens:output_type -> auth.UpdateTokensResponce
