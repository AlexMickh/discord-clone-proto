...
type AuthClient interface {
	...
	UpdateTokens(ctx context.Context, in *UpdateTokensRequest, opts ...grpc.CallOption) (*UpdateTokensResponce, error)
}
...
func (c *authClient) UpdateTokens(ctx context.Context, in *UpdateTokensRequest, opts ...grpc.CallOption) (*UpdateTokensResponce, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(UpdateTokensResponce)
...
type AuthServer interface {
	...
	UpdateTokens(context.Context, *UpdateTokensRequest) (*UpdateTokensResponce, error)
...
func (UnimplementedAuthServer) UpdateTokens(context.Context, *UpdateTokensRequest) (*UpdateTokensResponce, error) {
